...
def run_simulation(test_year,season,model_dir,pad_len=24,data_dir="../data/",output_dir="../model_output/"):
    ...
    print("Avg:",math.sqrt(mean_squared_error(results[0],results[1])))
...
def train_model(train_data,test_data,years,test_year,model_dir,output_dir="../model_output/"):
    ...
    train_y = np.expand_dims(train_mb,axis=-1)
    train_tr_year = train_trans_year
    ...
    gp_pred,gp_var = gp_pred_tup[0],gp_pred_tup[1]
    results = (test_y,gp_pred,gp_var)
